...
export const OPERATIONAL_COUNTRIES: CountryOperationalConfig[] = [
  ...
  },
  {
    ...
    currencyCode: 'BSD',
    currencySymbol: 'B$',
    exchangeRateToUSD: 1.0, // Pegged 1:1 with USD
    isStrictlyExcluded: false,
    targetHourlyEarningsUSD: { min: 8.0, max: 16.0, highPerformer: 22.0 },
    marketAdjustmentType: 'developing_market_baseline',
    supportedVehicleClasses: ['2_wheeler', '4_wheeler'],
    paymentRails: [
      { id: 'bs_sanddollar', name: 'Sand Dollar CBDC', type: 'mobile_money', provider: 'Central Bank of The Bahamas', settlementSpeed: 'Instant', currency: 'BSD', iconName: 'smartphone' },
      { id: 'bs_suncash', name: 'SunCash Digital Wallet', type: 'mobile_money', provider: 'SunCash Bahamas', settlementSpeed: 'Instant', currency: 'BSD', iconName: 'smartphone' },
      { id: 'bs_islandpay', name: 'Island Pay Wallet', type: 'mobile_money', provider: 'Island Pay', settlementSpeed: 'Instant', currency: 'BSD', iconName: 'smartphone' },
      { id: 'bs_cash', name: 'Bahamian Dollar Cash', type: 'cash_on_delivery', provider: 'Wap Escrow', settlementSpeed: 'Immediate', currency: 'BSD', iconName: 'banknote' }
    ],
    sampleCity: 'Nassau (Downtown / Paradise Island)',
    centerCoordinates: { lat: 25.0479, lng: -77.3554 },
    baseFareUSD: 2.5,
    perMinuteRateUSD: 0.22,
    perKmRateUSD: 0.85,
    minimumTripFloorUSD: 3.8,
    surgeCapMultiplier: 1.5
  },
  {
    code: 'CW',
    ...
    currencyCode: 'ANG',
    currencySymbol: 'NAƒ',
    exchangeRateToUSD: 1.80, // Pegged to USD
    isStrictlyExcluded: false,
    targetHourlyEarningsUSD: { min: 7.0, max: 14.0, highPerformer: 19.0 },
    marketAdjustmentType: 'developing_market_baseline',
    supportedVehicleClasses: ['2_wheeler', '4_wheeler'],
    paymentRails: [
      { id: 'cw_pagafasil', name: 'Pagafasil Mobile', type: 'mobile_money', provider: 'Pagafasil Curaçao', settlementSpeed: 'Instant', currency: 'ANG', iconName: 'smartphone' },
      { id: 'cw_sentoo', name: 'Sentoo Instant Payment QR', type: 'instant_bank_qr', provider: 'Sentoo Payment', settlementSpeed: 'Instant', currency: 'ANG', iconName: 'qr-code' },
      { id: 'cw_cash', name: 'Antillean Guilder Cash', type: 'cash_on_delivery', provider: 'Wap Escrow', settlementSpeed: 'Immediate', currency: 'ANG', iconName: 'banknote' }
    ],
    sampleCity: 'Willemstad (Punda / Otrobanda)',
    centerCoordinates: { lat: 12.1696, lng: -68.9900 },
    baseFareUSD: 1.8,
    perMinuteRateUSD: 0.16,
    perKmRateUSD: 0.65,
    minimumTripFloorUSD: 3.0,
    surgeCapMultiplier: 1.5
  },
  {
    code: 'BB',
    ...
    currencyCode: 'BBD',
    currencySymbol: 'Bds$',
    exchangeRateToUSD: 2.0, // Pegged 2:1 to USD
    isStrictlyExcluded: false,
    targetHourlyEarningsUSD: { min: 7.0, max: 14.0, highPerformer: 18.0 },
    marketAdjustmentType: 'developing_market_baseline',
    supportedVehicleClasses: ['2_wheeler', '4_wheeler'],
    paymentRails: [
      { id: 'bb_mmoney', name: 'mMoney Barbados', type: 'mobile_money', provider: 'Bitt mMoney', settlementSpeed: 'Instant', currency: 'BBD', iconName: 'smartphone' },
      { id: 'bb_firstpay', name: '1st Pay FirstCaribbean', type: 'instant_bank_qr', provider: 'CIBC FirstCaribbean', settlementSpeed: 'Instant', currency: 'BBD', iconName: 'qr-code' },
      { id: 'bb_cash', name: 'Barbadian Dollar Cash', type: 'cash_on_delivery', provider: 'Wap Escrow', settlementSpeed: 'Immediate', currency: 'BBD', iconName: 'banknote' }
    ],
    sampleCity: 'Bridgetown (Broad Street / St. Michael)',
    centerCoordinates: { lat: 13.1939, lng: -59.5432 },
    baseFareUSD: 1.8,
    perMinuteRateUSD: 0.16,
    perKmRateUSD: 0.68,
    minimumTripFloorUSD: 3.0,
  ...
  },
  {
    ...
    currencyCode: 'XCD',
    currencySymbol: 'EC$',
    exchangeRateToUSD: 2.70, // ECCB Peg
    isStrictlyExcluded: false,
    targetHourlyEarningsUSD: { min: 6.5, max: 13.0, highPerformer: 17.0 },
    marketAdjustmentType: 'developing_market_baseline',
    supportedVehicleClasses: ['2_wheeler', '3_wheeler', '4_wheeler'],
    paymentRails: [
      { id: 'kn_caribepay', name: 'CaribePay St. Kitts', type: 'mobile_money', provider: 'CaribePay', settlementSpeed: 'Instant', currency: 'XCD', iconName: 'smartphone' },
      { id: 'kn_mobanking', name: 'St. Kitts-Nevis-Anguilla National Bank Mobile', type: 'mobile_money', provider: 'SKNANB', settlementSpeed: 'Instant', currency: 'XCD', iconName: 'smartphone' },
      { id: 'kn_cash', name: 'Eastern Caribbean Dollar Cash', type: 'cash_on_delivery', provider: 'Wap Escrow', settlementSpeed: 'Immediate', currency: 'XCD', iconName: 'banknote' }
    ],
    sampleCity: 'Basseterre (The Circus / Port Zante)',
    centerCoordinates: { lat: 17.3026, lng: -62.7177 },
    baseFareUSD: 1.5,
    perMinuteRateUSD: 0.14,
    perKmRateUSD: 0.55,
    minimumTripFloorUSD: 2.5,
  ...
  },
  {
    ...
    exchangeRateToUSD: 605.0,
    isStrictlyExcluded: false,
    targetHourlyEarningsUSD: { min: 4.5, max: 9.0, highPerformer: 13.0 },
    marketAdjustmentType: 'developing_market_baseline',
    supportedVehicleClasses: ['2_wheeler', '3_wheeler', '4_wheeler'],
    paymentRails: [
      { id: 'ml_orange', name: 'Orange Money Mali', type: 'mobile_money', provider: 'Orange Mali', settlementSpeed: 'Instant', currency: 'XOF', iconName: 'smartphone' },
      { id: 'ml_moov', name: 'Moov Money Mali', type: 'mobile_money', provider: 'Moov Africa Malitel', settlementSpeed: 'Instant', currency: 'XOF', iconName: 'smartphone' },
      { id: 'ml_sama', name: 'Sama Money', type: 'mobile_money', provider: 'Sama Money SA', settlementSpeed: 'Instant', currency: 'XOF', iconName: 'smartphone' },
      { id: 'ml_cash', name: 'Franc CFA Cash', type: 'cash_on_delivery', provider: 'Wap Escrow', settlementSpeed: 'Immediate', currency: 'XOF', iconName: 'banknote' }
    ],
    sampleCity: 'Bamako (Badalabougou / Grand Marché)',
    centerCoordinates: { lat: 12.6392, lng: -8.0029 },
    baseFareUSD: 0.85,
    perMinuteRateUSD: 0.06,
    perKmRateUSD: 0.26,
    minimumTripFloorUSD: 1.2,
    surgeCapMultiplier: 1.5
  },
  {
    code: 'NE',
    ...
    exchangeRateToUSD: 605.0,
    isStrictlyExcluded: false,
    targetHourlyEarningsUSD: { min: 4.2, max: 8.5, highPerformer: 12.0 },
    marketAdjustmentType: 'developing_market_baseline',
    supportedVehicleClasses: ['2_wheeler', '3_wheeler', '4_wheeler'],
    paymentRails: [
      { id: 'ne_airtel', name: 'Airtel Money Niger', type: 'mobile_money', provider: 'Airtel Niger', settlementSpeed: 'Instant', currency: 'XOF', iconName: 'smartphone' },
      { id: 'ne_moov', name: 'Moov Africa Niger', type: 'mobile_money', provider: 'Moov Niger', settlementSpeed: 'Instant', currency: 'XOF', iconName: 'smartphone' },
      { id: 'ne_alizza', name: 'Al Izza Express Transfer', type: 'mobile_money', provider: 'Al Izza Niger', settlementSpeed: 'Instant', currency: 'XOF', iconName: 'smartphone' },
      { id: 'ne_cash', name: 'Franc CFA Cash', type: 'cash_on_delivery', provider: 'Wap Escrow', settlementSpeed: 'Immediate', currency: 'XOF', iconName: 'banknote' }
    ],
    sampleCity: 'Niamey (Plateau / Grand Marché)',
    centerCoordinates: { lat: 13.5116, lng: 2.1254 },
    baseFareUSD: 0.8,
    perMinuteRateUSD: 0.06,
    perKmRateUSD: 0.25,
    minimumTripFloorUSD: 1.1,
    surgeCapMultiplier: 1.5
  },
  {
    code: 'CG',
    ...
    supportedVehicleClasses: ['2_wheeler', '3_wheeler', '4_wheeler'],
    paymentRails: [
      { id: 'cg_mtn', name: 'MTN Mobile Money Congo', type: 'mobile_money', provider: 'MTN Congo', settlementSpeed: 'Instant', currency: 'XAF', iconName: 'smartphone' },
      { id: 'cg_airtel', name: 'Airtel Money Congo', type: 'mobile_money', provider: 'Airtel Congo', settlementSpeed: 'Instant', currency: 'XAF', iconName: 'smartphone' },
      { id: 'cg_cash', name: 'Franc CFA (BEAC) Cash', type: 'cash_on_delivery', provider: 'Wap Escrow', settlementSpeed: 'Immediate', currency: 'XAF', iconName: 'banknote' }
    ],
    sampleCity: 'Brazzaville (Poto-Poto / Bacongo)',
    centerCoordinates: { lat: -4.2634, lng: 15.2429 },
    baseFareUSD: 1.0,
    perMinuteRateUSD: 0.08,
    perKmRateUSD: 0.32,
    minimumTripFloorUSD: 1.5,
  ...
  },
  {
    ...
    supportedVehicleClasses: ['2_wheeler', '3_wheeler', '4_wheeler'],
    paymentRails: [
      { id: 'cd_mpesa', name: 'M-Pesa RDC (Vodacom)', type: 'mobile_money', provider: 'Vodacom DRC', settlementSpeed: 'Instant', currency: 'CDF', iconName: 'smartphone' },
      { id: 'cd_orange', name: 'Orange Money RDC', type: 'mobile_money', provider: 'Orange DRC', settlementSpeed: 'Instant', currency: 'CDF', iconName: 'smartphone' },
      { id: 'cd_airtel', name: 'Airtel Money RDC', type: 'mobile_money', provider: 'Airtel DRC', settlementSpeed: 'Instant', currency: 'CDF', iconName: 'smartphone' },
      { id: 'cd_cash', name: 'Franc Congolais Cash', type: 'cash_on_delivery', provider: 'Wap Escrow', settlementSpeed: 'Immediate', currency: 'CDF', iconName: 'banknote' }
    ],
    sampleCity: 'Kinshasa (Gombe / Kintambo / Victoire)',
    centerCoordinates: { lat: -4.4419, lng: 15.2663 },
    baseFareUSD: 1.1,
    perMinuteRateUSD: 0.09,
    perKmRateUSD: 0.35,
    minimumTripFloorUSD: 1.6,
  ...
  },
  {
    ...
    supportedVehicleClasses: ['2_wheeler', '3_wheeler', '4_wheeler'],
    paymentRails: [
      { id: 'zm_mtn', name: 'MTN MoMo Zambia', type: 'mobile_money', provider: 'MTN Zambia', settlementSpeed: 'Instant', currency: 'ZMW', iconName: 'smartphone' },
      { id: 'zm_airtel', name: 'Airtel Money Zambia', type: 'mobile_money', provider: 'Airtel Zambia', settlementSpeed: 'Instant', currency: 'ZMW', iconName: 'smartphone' },
      { id: 'zm_zamtel', name: 'Zamtel Kwacha', type: 'mobile_money', provider: 'Zamtel', settlementSpeed: 'Instant', currency: 'ZMW', iconName: 'smartphone' },
      { id: 'zm_cash', name: 'Zambian Kwacha Cash', type: 'cash_on_delivery', provider: 'Wap Escrow', settlementSpeed: 'Immediate', currency: 'ZMW', iconName: 'banknote' }
    ],
    sampleCity: 'Lusaka (Cairo Road / Woodlands / Northmead)',
    centerCoordinates: { lat: -15.3875, lng: 28.3228 },
    baseFareUSD: 1.0,
    perMinuteRateUSD: 0.08,
    perKmRateUSD: 0.32,
    minimumTripFloorUSD: 1.4,
    surgeCapMultiplier: 1.5
  },
  {
    code: 'NA',
    ...
    currencyCode: 'NAD',
    currencySymbol: 'N$',
    exchangeRateToUSD: 17.8, // Pegged 1:1 with ZAR
    isStrictlyExcluded: false,
    targetHourlyEarningsUSD: { min: 6.0, max: 12.0, highPerformer: 16.0 },
    marketAdjustmentType: 'developing_market_baseline',
    supportedVehicleClasses: ['2_wheeler', '4_wheeler'],
    paymentRails: [
      { id: 'na_paytoday', name: 'PayToday Namibia', type: 'mobile_money', provider: 'PayToday', settlementSpeed: 'Instant', currency: 'NAD', iconName: 'smartphone' },
      { id: 'na_fnb', name: 'FNB eWallet Namibia', type: 'instant_bank_qr', provider: 'First National Bank Namibia', settlementSpeed: 'Instant', currency: 'NAD', iconName: 'qr-code' },
      { id: 'na_cash', name: 'Namibian Dollar Cash', type: 'cash_on_delivery', provider: 'Wap Escrow', settlementSpeed: 'Immediate', currency: 'NAD', iconName: 'banknote' }
    ],
    sampleCity: 'Windhoek (Independence Avenue / Katutura)',
    centerCoordinates: { lat: -22.5609, lng: 17.0658 },
    baseFareUSD: 1.3,
    perMinuteRateUSD: 0.11,
    perKmRateUSD: 0.45,
    minimumTripFloorUSD: 2.0,
  ...
  },
  {
    ...
    exchangeRateToUSD: 605.0,
    isStrictlyExcluded: false,
    targetHourlyEarningsUSD: { min: 4.8, max: 9.5, highPerformer: 13.5 },
    marketAdjustmentType: 'developing_market_baseline',
    supportedVehicleClasses: ['2_wheeler', '3_wheeler', '4_wheeler'],
    paymentRails: [
      { id: 'bj_mtn', name: 'MTN MoMo Bénin', type: 'mobile_money', provider: 'MTN Bénin', settlementSpeed: 'Instant', currency: 'XOF', iconName: 'smartphone' },
      { id: 'bj_moov', name: 'Moov Money Bénin', type: 'mobile_money', provider: 'Moov Africa Bénin', settlementSpeed: 'Instant', currency: 'XOF', iconName: 'smartphone' },
      { id: 'bj_celtiis', name: 'Celtiis Cash', type: 'mobile_money', provider: 'SBIN Celtiis', settlementSpeed: 'Instant', currency: 'XOF', iconName: 'smartphone' },
      { id: 'bj_cash', name: 'Franc CFA Cash', type: 'cash_on_delivery', provider: 'Wap Escrow', settlementSpeed: 'Immediate', currency: 'XOF', iconName: 'banknote' }
    ],
    sampleCity: 'Cotonou (Dantokpa / Haie Vive / Cadjehoun)',
    centerCoordinates: { lat: 6.3703, lng: 2.3912 },
    baseFareUSD: 0.85,
    perMinuteRateUSD: 0.06,
    perKmRateUSD: 0.28,
    minimumTripFloorUSD: 1.2,
...
export const FLEET_HEATMAP_DATA: FleetHeatmapNode[] = [
  ...
  { id: 'node-nas', countryCode: 'BS', city: 'Nassau', coordinates: { lat: 25.0479, lng: -77.3554 }, activeTwoWheelers: 110, activeThreeWheelers: 20, activeFourWheelers: 145, demandSurgeLevel: 1.35, averageHourlyEarningUSD: 14.5, status: 'high_demand' },
  { id: 'node-cur', countryCode: 'CW', city: 'Willemstad', coordinates: { lat: 12.1696, lng: -68.9900 }, activeTwoWheelers: 85, activeThreeWheelers: 15, activeFourWheelers: 95, demandSurgeLevel: 1.25, averageHourlyEarningUSD: 12.8, status: 'normal' },
  { id: 'node-bgi', countryCode: 'BB', city: 'Bridgetown', coordinates: { lat: 13.1939, lng: -59.5432 }, activeTwoWheelers: 92, activeThreeWheelers: 12, activeFourWheelers: 110, demandSurgeLevel: 1.3, averageHourlyEarningUSD: 13.2, status: 'normal' },
  { id: 'node-bas', countryCode: 'KN', city: 'Basseterre', coordinates: { lat: 17.3026, lng: -62.7177 }, activeTwoWheelers: 45, activeThreeWheelers: 14, activeFourWheelers: 32, demandSurgeLevel: 1.15, averageHourlyEarningUSD: 10.5, status: 'normal' },
  { id: 'node-bko', countryCode: 'ML', city: 'Bamako', coordinates: { lat: 12.6392, lng: -8.0029 }, activeTwoWheelers: 380, activeThreeWheelers: 140, activeFourWheelers: 75, demandSurgeLevel: 1.4, averageHourlyEarningUSD: 7.2, status: 'high_demand' },
  { id: 'node-nim', countryCode: 'NE', city: 'Niamey', coordinates: { lat: 13.5116, lng: 2.1254 }, activeTwoWheelers: 260, activeThreeWheelers: 110, activeFourWheelers: 48, demandSurgeLevel: 1.25, averageHourlyEarningUSD: 6.8, status: 'normal' },
  { id: 'node-bzv', countryCode: 'CG', city: 'Brazzaville', coordinates: { lat: -4.2634, lng: 15.2429 }, activeTwoWheelers: 290, activeThreeWheelers: 95, activeFourWheelers: 82, demandSurgeLevel: 1.3, averageHourlyEarningUSD: 7.9, status: 'normal' },
  { id: 'node-fih', countryCode: 'CD', city: 'Kinshasa', coordinates: { lat: -4.4419, lng: 15.2663 }, activeTwoWheelers: 640, activeThreeWheelers: 280, activeFourWheelers: 160, demandSurgeLevel: 1.5, averageHourlyEarningUSD: 8.1, status: 'surge_capped' },
  { id: 'node-lun', countryCode: 'ZM', city: 'Lusaka', coordinates: { lat: -15.3875, lng: 28.3228 }, activeTwoWheelers: 310, activeThreeWheelers: 85, activeFourWheelers: 95, demandSurgeLevel: 1.3, averageHourlyEarningUSD: 7.8, status: 'normal' },
  { id: 'node-wdh', countryCode: 'NA', city: 'Windhoek', coordinates: { lat: -22.5609, lng: 17.0658 }, activeTwoWheelers: 130, activeThreeWheelers: 25, activeFourWheelers: 120, demandSurgeLevel: 1.2, averageHourlyEarningUSD: 11.4, status: 'normal' },
  { id: 'node-coo', countryCode: 'BJ', city: 'Cotonou', coordinates: { lat: 6.3703, lng: 2.3912 }, activeTwoWheelers: 440, activeThreeWheelers: 170, activeFourWheelers: 65, demandSurgeLevel: 1.45, averageHourlyEarningUSD: 7.6, status: 'high_demand' },
